...
%erehrere
%\end{abstract}
Overshooting is a feature of financial markets, particularly foreign exchange. There are two aspects to your task: discuss the root causes of overshooting; creating a trading tool that can be used to take advantage of overshooting.  You may concentrate on either of these parts of the task or a combination of the two.  The presentation should be approximately 10 minutes with time for questions. 
...
\item Are there any signals that may tell us that exchange rates are at extreme levels?  Many market pacticipants try to use inside information about the positions held by speculators.  There is some information on this from the US regulatory body the CFTC.  Search for the \emph{commitment of traders}. 

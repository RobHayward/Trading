...
\begin{frame}{Technical trading rules}
Three themes
\pause
\begin{itemize}[<+-| alert@+>]
\item Momentum or trend with moving average
\item Over-shooting with standard deviation
\item Support and resistance with maximum and minimum
\end{itemize}
\end{frame}
